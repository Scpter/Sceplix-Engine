...
// TODO: create our own string library
#include "string.h"
#include "stdio.h"
...
void* sallocate(u64 size, memory_tag tag) {
    if (tag == MEMORY_TAG_UNKNOWN) {
        SWARN("SAllocate called using MEMORY_TAG_UNKOWN. Re-class this allocation!");
    }
...
char* get_memory_usage_str() {
    const u64 gib = 1024 * 1024 * 1024; // computers uses multiples of 1024
